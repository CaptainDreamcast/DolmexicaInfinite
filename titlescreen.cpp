...
static void loadCredits() {
	...
	gTitleScreenData.mLeftCreditTextID = addMugenText("Dolmexica Infinite Demo 8", makePosition(0, 240, 51), 1);
	
	gTitleScreenData.mRightCreditTextID = addMugenText("05/03/19 Presented by Dogma", makePosition(320, 240, 51), 1);
